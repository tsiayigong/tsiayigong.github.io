...
// 隐藏菜单
rm.hideRightMenu = function(x=0,y=0){
  let $rightMenu = $('#rightMenu');
  $rightMenu.css('top',x+'px').css('left',y+'px');
...
rm.searchBaidu = function(){
  ...
  setTimeout(function(){
    ...
    window.open('https://www.google.com.hk/search?hl=zh-CN&q=' + selectTextNow);
  }, "2000");
  rm.hideRightMenu();
}
...
function addRightMenuClickEvent(){
  ...
  $('#menu-downloadimg').on('click',function(){heo.downloadImage(domImgSrc,'TYU');});
